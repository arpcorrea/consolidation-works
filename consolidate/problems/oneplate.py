...
class OnePlate:
    ...
    def set_boundaryconds(self, deck):
        ...
        for deck_BC in deck.doc["Boundary Conditions"]:
            if deck_BC == "Top":
                self.boundaryconditions.append(LinearBC((0., self.Ly), (self.Lx, self.Ly),
                                                        deck.doc["Boundary Conditions"][deck_BC]))
            elif deck_BC == "Bottom":
                self.boundaryconditions.append(
                    LinearBC((0., 0.), (self.Lx, 0.), deck.doc["Boundary Conditions"][deck_BC]))
            elif deck_BC == "Left":
                self.boundaryconditions.append(
                    LinearBC((0., 0.), (0., self.Ly), deck.doc["Boundary Conditions"][deck_BC]))
            elif deck_BC == "Right":
                self.boundaryconditions.append(LinearBC((self.Lx, 0.), (self.Lx, self.Ly),
                                                        deck.doc["Boundary Conditions"][deck_BC]))
